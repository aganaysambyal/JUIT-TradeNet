...
function MyProducts() {
  ...
  useEffect(() => {
    ...
    axios
      .post("http://localhost:4000/my-products", { userId })
      .then((res) => {
  ...
  const handleLike = (productId) => {
    ...
    axios
      .post("http://localhost:4000/like-product", { userId, productId })
      .then((res) => {
  ...
  const handleRemove = (productId) => {
    ...
    axios.delete(`http://localhost:4000/delete-product/${productId}`, {
      data: { userId }
    })
    .then((res) => {
